...
function Feeding() {
      ...
      async function fetchFeedingSchedule() {
        try {
          const res = await fetch(
            `${process.env.API_URL}v1/baby/${baby_id}/getFeedingSchedules`,
            {
              method: "GET",
              headers: {
  ...
  const handleSaveMeal = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.API_URL}v1/baby/${selectedMeal.baby_id}/updateFeedingSchedule/${meal_id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleSaveNewFeed = () => {
    ...
    fetch("${process.env.API_URL}v1/addSchedule", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleDeleteMeal = async (mealItem, date) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.API_URL}v1/baby/${mealItem.baby_id}/deleteFeedingSchedule/${meal_id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
