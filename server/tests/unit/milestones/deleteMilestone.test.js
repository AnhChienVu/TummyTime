...
// Tests the DELETE /v1/baby/:baby_id/deleteMilestone/:milestone_id route
...
app.delete(
  '/v1/baby/:baby_id/deleteMilestone/:milestone_id',
  authenticate(),
  deleteMilestoneById
);
...
describe('DELETE /v1/baby/:baby_id/deleteMilestone/:milestone_id', () => {
  describe('Milestones API', () => {
    ...
    test('should return 200 when a milestone is successfully deleted', async () => {
      ...
      const res = await request(app)
        .delete('/v1/baby/1/deleteMilestone/1')
    ...
    test('should return 404 when the milestone is not found', async () => {
      ...
      const res = await request(app)
        .delete('/v1/baby/1/deleteMilestone/999')
        .set('Authorization', `Bearer ${token}`); // Include the token in the Authorization header
