...
// Tests the DELETE /growth/:growthId route
...
app.delete('/v1/growth/:growthId', deleteGrowthById); // DELETE /users/:growthId
...
describe('DELETE /growth/:growthId', () => {
  ...
  test('should return 404 if the growth record is not found', async () => {
    ...
    const res = await request(app).delete('/v1/growth/999');
